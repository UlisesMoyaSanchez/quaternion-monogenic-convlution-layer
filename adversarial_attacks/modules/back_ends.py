...
# https://github.com/dicarlolab/vonenet/blob/master/vonenet/back_ends.py
# and 
...
class AlexNetBackEnd(nn.Module):
    def __init__(self, num_classes=1000):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(18, 192, kernel_size=5, stride=2, padding=2),
...
class ResNetBackEnd(nn.Module):
    def __init__(self, block, layers, inplanes=6, num_classes=10, zero_init_residual=False,
